...
class ProductController extends Controller
{
    ...
    {
       $products = SanPham::with(['bienthe.anh', 'bienthe.mau','bienthe.kichthuoc','bienthe.trangthai','bienthe.magiamgia'])->get();
    ...
    {
          $products = SanPham::with(['bienthe.anh', 'bienthe.mau','bienthe.kichthuoc','bienthe.trangthai','bienthe.magiamgia'])->where('id',$id)->get();
